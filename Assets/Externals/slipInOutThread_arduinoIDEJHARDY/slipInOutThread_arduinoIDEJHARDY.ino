...
const int sensorPinA = 0; //L'entrée analogique utilisée.
//JH
const int sensorPinB = 1;//une deuxieme entrée utlisée
//
...
void readSensor(){ // fonction exécutée par le Thread.
  ...
  //
  /*Serial.write(END);   // On commence le paquet.//Si on duplique totu ça ça envoie deux paquets, mais il fait pas la différence entre les deux paquets, il recoit tout au meme endtoit//Donc on 
